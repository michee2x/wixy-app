    ...
    <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 lg:gap-12">
      ...
      <div>
        <div className="rounded-lg border p-4">
          ...
          <a href="#" className="block hidden rounded-lg border bg-white px-4 py-2 text-center text-sm font-semibold text-gray-500 outline-none ring-indigo-300 transition duration-100 hover:bg-gray-100 focus-visible:ring active:bg-gray-200 md:px-8 md:py-3 md:text-base">Write a review</a>
        </div>
      </div>
      {/* <!-- overview - end --> */}
