...
export const CookieComponent = () => {
  ...
  const [show, setShow] = useState(true);
    ...
    return (
        <>
        <section className={`fixed ${(show && !loggedUser) ? "block" : "hidden"} w-[90%] h-auto lg:w-1/3 z-50 shadow-lg left-1/2 transform -translate-x-1/2 shadow-black/10 max-w-md p-4 mx-auto bg-white border border-gray-200 dark:bg-gray-800 bottom-12 dark:border-gray-700 rounded-2xl`}>
